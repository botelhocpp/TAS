...
const instruction::Instruction kInstructionList[] = {
    ...
    {"blt",  0x1802, 1, instruction::InstructionType::kTypeBranch},
    {"bge",  0x1803, 1, instruction::InstructionType::kTypeBranch},
    ...
    {"movu", 0x5000, 2, instruction::InstructionType::kTypeAlu},
    {"add",  0x6000, 3, instruction::InstructionType::kTypeAlu},
    {"sub",  0x7000, 3, instruction::InstructionType::kTypeAlu},
